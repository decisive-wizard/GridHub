    ...
    var formulaRenderer = function (instance, TD, row, col, prop, valueObj, cellProperties) {
      if (instance.formulasEnabled) {
        ...
        if ((valueObj.formula && valueObj.formula[0] === '=') || needUpdate) {
          ...
          if (!error || formula !== prevFormula || true) {
            ...
            if (newValue.result !== null){
              ...
              instance.plugin.matrix.updateItem(currentItem, {formula: formula, value: result, error: newValue.error, needUpdate: false});
      ...
      if (source === 'edit' || source === 'undo' || source === 'autofill') {
        ...
        changes.forEach(function (item) {
          ...
          // (prevValueObj && prevValueObj.value !== valueObj.value)) {
            ...
            console.log(cellId, instance.plugin.matrix.getItem(cellId));
            ...
            deps.forEach(function (itemId) {
              ...
              // needs to update reference cell here,
              // rerun all calc and render functions here
              var A2 = instance.plugin.matrix.getItem('A2') || "";
              var C2 = instance.plugin.matrix.getItem('C2') || "";
              var C3 = instance.plugin.matrix.getItem('C3') || "";
              console.log(itemId,A2,C2,C3);
            });
